                        ...
                        var obj = jQuery.parseJSON(result);
                            if(obj != '')
                            {
                                    ...
                                    $.each(obj, function(key, val) {
                                            var tr = "<tr><a href='user_history_report.php?user_id="+val["id"]+"' class='btn btn-sm btn-primary'>View</a></td></tr>";
    ...
    ?>
            ...
            <input type="submit" value="Submit">
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <h5 class="card-header">Search Name User</h5>
                            <div class="card-body">
                            <div class="mb-3">
            <form action="/user_history_report2.php">
